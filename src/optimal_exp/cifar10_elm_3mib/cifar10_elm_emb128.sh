...
EMB=128
i=0
python3 ../../main.py --dataset CIFAR10 --num_classes_per_task 2 --num_tasks 5 --seed $i --memory_size $MEM --num_passes 128 --regularization none --width 400 --model ELM_cifar --emb $EMB --exp_name CIFAR10_ELM_3mib_EMB${EMB}_MEM${MEM}_${i}
