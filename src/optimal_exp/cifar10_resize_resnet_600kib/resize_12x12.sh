...
python ../../main.py --dataset CIFAR10 --num_classes_per_task 2 --num_tasks 5 --seed 0 --memory_size $MEM --num_passes 256 --resize $RES --regularization cutmix --model ResNet --depth 18 --exp_name cifar10_600kib_resize_${RES}x${RES}_s0
